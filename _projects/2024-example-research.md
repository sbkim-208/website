...
Write the full description of the project here in **Markdown**. This body only
shows on the project's own page (`/projects/2024-example-research/`).

You can include images, math, lists, code — anything Markdown supports.
